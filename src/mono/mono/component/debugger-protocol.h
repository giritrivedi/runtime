...
typedef enum {
	...
	MDBGPROT_CMD_METHOD_GET_PRETTY_NAME = 16,
	MDBGPROT_CMD_METHOD_BIND_GENERIC_TYPE_PARAMETERS = 17
} MdbgProtCmdMethod;
...
typedef enum {
	...
	MDBGPROT_CMD_TYPE_GET_VALUES_BY_FIELD_TOKEN = 21,
...
typedef enum {
	...
	MDBGPROT_CMD_STACK_FRAME_GET_PARAMETERS_COUNT = 11,
        MDBGPROT_CMD_STACK_FRAME_GET_LOCALS = 12,
...
typedef enum {
	...
	MDBGPROT_CMD_ARRAY_REF_GET_SIZE = 5
} MdbgProtCmdArray;
...
typedef enum {
	...
	MDBGPROT_CMD_OBJECT_REF_GET_VALUES_BY_FIELD_TOKEN = 8,
	MDBGPROT_CMD_OBJECT_REF_DELEGATE_GET_METHOD = 9,
	MDBGPROT_CMD_OBJECT_IS_DELEGATE = 10,
	MDBGPROT_CMD_OBJECT_REF_SET_VALUES_BY_FIELD_TOKEN = 11
} MdbgProtCmdObject;
