...
INST(sqebr,     "sqebr",        0,      0xb314)
INST(sqdbr,     "sqdbr",        0,      0xb315)
...
INST(cefbr,     "cefbr",        0,      0xb394)
INST(cdfbr,     "cdfbr",        0,      0xb395)
INST(cegbr,     "cegbr",        0,      0xb3a4)
INST(cdgbr,     "cdgbr",        0,      0xb3a5)
INST(celfbr,    "celfbr",       0,      0xb390)
INST(cdlfbr,    "cdlfbr",       0,      0xb391)
INST(celgbr,    "celgbr",       0,      0xb3a0)
INST(cdlgbr,    "cdlgbr",       0,      0xb3a1)
...
INST(ar,        "ar",           0,      0x1a)
INST(sr,        "sr",           0,      0x1b)
INST(sgr,       "sgr",          0,      0xb909)
INST(xr,        "xr",           0,      0x17)
INST(or,        "or",           0,      0x16)
INST(ogr,       "ogr",          0,      0xb981)
INST(nr,        "nr",           0,      0x14)
INST(msgr,      "msgr",         0,      0xb90c)
INST(msr,       "msr",          0,      0xb252)
INST(ngr,       "ngr",          0,      0xb980)
INST(mr,        "mr",           0,      0x1c)
...
INST(cgfr,      "cgfr",         0,      0xB930)
INST(clr,       "clr",          0,      0x15)
INST(clgr,      "clgr",         0,      0xB921)
INST(clgfr,     "clgfr",        0,      0xB931)
INST(ltgr,      "ltgr",         0,      0xB902)
